...
var o45650 = temp__5455__auto__;
var temp__5455__auto____$1 = (o45650["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o45651 = temp__5455__auto____$1;
return (o45651["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23893__auto__ = f;
return (o__23893__auto__["toString"]).call(o__23893__auto__);
} else {
return "";
}
}catch (e45652){var _ = e45652;
return "";
}});
...
try{var o__23893__auto___45654 = t;
(o__23893__auto___45654["cljs$lang$ctorPrWriter"]).call(o__23893__auto___45654,t,writer);
}catch (e45653){var __45655 = e45653;
}
...
var char_code = (function (){var o__23893__auto__ = (new String(char$));
return (o__23893__auto__["charCodeAt"]).call(o__23893__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23893__auto__ = String;
return (o__23893__auto__["fromCharCode"]).call(o__23893__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__45656 = num_code;
switch (G__45656) {
case (1):
return (185);
...
var o__23893__auto__ = String;
return (o__23893__auto__["fromCharCode"]).call(o__23893__auto__,superscript_code);
});
/**
...
}catch (e45658){var _e__23900__auto__ = e45658;
return false;
}})())){
...
var vec__45659 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__45659,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o45662 = temp__5455__auto__;
var temp__5455__auto____$1 = (o45662["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o45663 = temp__5455__auto____$1;
return (o45663["nameToPath"]);
} else {
return null;
}
} else {
...
var G__45672 = (i__4500__auto___45671 + (1));
i__4500__auto___45671 = G__45672;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__45666){
var vec__45667 = p__45666;
var ns_detector = cljs.core.nth.call(null,vec__45667,(0),null);
...
var G__45673 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__45674 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__45673;
remaining_tokens = G__45674;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq45664){
var G__45665 = cljs.core.first.call(null,seq45664);
var seq45664__$1 = cljs.core.next.call(null,seq45664);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45665,seq45664__$1);
});
...
var vec__45678 = cljs.core.split_with.call(null,(function (p1__45677_SHARP_){
return cljs.core.not_EQ_.call(null,p1__45677_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__45678,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__45678,(1),null);
...
var vec__45681 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__45681,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__45681,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__45684 = cljs.core.rest.call(null,remaining_tokens);
var G__45685 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__45684;
name_tokens = G__45685;
continue;
} else {
...
var vec__45688 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__45688,(0),null);
var arity = cljs.core.nth.call(null,vec__45688,(1),null);
var vec__45691 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__45691,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__45691,(1),null);
var vec__45694 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__45694,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__45694,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__45694,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__45694,(3),null);
...
var vec__45700 = result;
var munged_ns = cljs.core.nth.call(null,vec__45700,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__45700,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__45700,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__45700,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__45700,(4),null);
var arity = cljs.core.nth.call(null,vec__45700,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__45704 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__45704,(0),null);
var args = cljs.core.nth.call(null,vec__45704,(1),null);
var vec__45707 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__45707,(0),null);
var name = cljs.core.nth.call(null,vec__45707,(1),null);
...
var G__45710 = (arity + (1));
var G__45711 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__45712){
var vec__45713 = p__45712;
var arity = cljs.core.nth.call(null,vec__45713,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__45713,(1),null);
...
return (function (p1__45716_SHARP_){
return cljs.core.get.call(null,arities,p1__45716_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__45717_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___45724 = arguments.length;
var i__4500__auto___45725 = (0);
while(true){
if((i__4500__auto___45725 < len__4499__auto___45724)){
args__4502__auto__.push((arguments[i__4500__auto___45725]));

var G__45726 = (i__4500__auto___45725 + (1));
i__4500__auto___45725 = G__45726;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__45720){
var vec__45721 = p__45720;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__45721,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq45718){
var G__45719 = cljs.core.first.call(null,seq45718);
var seq45718__$1 = cljs.core.next.call(null,seq45718);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45719,seq45718__$1);
});
...
var G__45727 = arg;
var G__45727__$1 = (((G__45727 instanceof cljs.core.Keyword))?G__45727.fqn:null);
switch (G__45727__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__45729__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__45729__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__45729__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__45729__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__45730 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__45730,(0),null);
var fn_name = cljs.core.nth.call(null,vec__45730,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__45730,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__45730,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__45730,(4),null);
var arity = cljs.core.nth.call(null,vec__45730,(5),null);
...
var o__23893__auto__ = f;
return (o__23893__auto__["getBasis"]).call(o__23893__auto__);
});
/**
...
}catch (e45734){var _e__23900__auto__ = e45734;
...
var G__45735 = (obj[cljs.core.first.call(null,path)]);
var G__45736 = cljs.core.rest.call(null,path);
obj = G__45735;
path = G__45736;
continue;
} else {
...
return (function (accum,p__45737){
var vec__45738 = p__45737;
var bit = cljs.core.nth.call(null,vec__45738,(0),null);
var protocol = cljs.core.nth.call(null,vec__45738,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__45741){
var vec__45742 = p__45741;
var ns = cljs.core.nth.call(null,vec__45742,(0),null);
var name = cljs.core.nth.call(null,vec__45742,(1),null);
var selector = cljs.core.nth.call(null,vec__45742,(2),null);
...
return (function (p__45746){
var vec__45747 = p__45746;
var munged_name = cljs.core.nth.call(null,vec__45747,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__45747,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__45747,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__45745_SHARP_){
return (obj[cljs.core.first.call(null,p1__45745_SHARP_)]);
});})(name,sorted_matches,vec__45747,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1557588315693
