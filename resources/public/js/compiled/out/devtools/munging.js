...
var temp__5455__auto____$1 = (o24961["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24962 = temp__5455__auto____$1;
return (o24962["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__23893__auto___24965 = t;
(o__23893__auto___24965["cljs$lang$ctorPrWriter"]).call(o__23893__auto___24965,t,writer);
}catch (e24964){var __24966 = e24964;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24967 = num_code;
switch (G__24967) {
case (1):
return (185);
...
}catch (e24969){var _e__23900__auto__ = e24969;
return false;
}})())){
...
var vec__24970 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24970,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o24973 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24973["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24974 = temp__5455__auto____$1;
return (o24974["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___24981 = arguments.length;
var i__4500__auto___24982 = (0);
while(true){
if((i__4500__auto___24982 < len__4499__auto___24981)){
args__4502__auto__.push((arguments[i__4500__auto___24982]));

var G__24983 = (i__4500__auto___24982 + (1));
i__4500__auto___24982 = G__24983;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24977){
var vec__24978 = p__24977;
var ns_detector = cljs.core.nth.call(null,vec__24978,(0),null);
...
var G__24984 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24985 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24984;
remaining_tokens = G__24985;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24975){
var G__24976 = cljs.core.first.call(null,seq24975);
var seq24975__$1 = cljs.core.next.call(null,seq24975);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24976,seq24975__$1);
});
...
var vec__24989 = cljs.core.split_with.call(null,(function (p1__24988_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24988_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24989,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24989,(1),null);
...
var vec__24992 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24992,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24992,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24995 = cljs.core.rest.call(null,remaining_tokens);
var G__24996 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24995;
name_tokens = G__24996;
continue;
} else {
...
var vec__24999 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24999,(0),null);
var arity = cljs.core.nth.call(null,vec__24999,(1),null);
var vec__25002 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25002,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25002,(1),null);
var vec__25005 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25005,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25005,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25005,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25005,(3),null);
...
var vec__25011 = result;
var munged_ns = cljs.core.nth.call(null,vec__25011,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25011,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25011,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25011,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25011,(4),null);
var arity = cljs.core.nth.call(null,vec__25011,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__25015 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__25015,(0),null);
var args = cljs.core.nth.call(null,vec__25015,(1),null);
var vec__25018 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25018,(0),null);
var name = cljs.core.nth.call(null,vec__25018,(1),null);
...
var G__25021 = (arity + (1));
var G__25022 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25023){
var vec__25024 = p__25023;
var arity = cljs.core.nth.call(null,vec__25024,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25024,(1),null);
...
return cljs.core.get.call(null,arities,p1__25027_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25028_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25031){
var vec__25032 = p__25031;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25032,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25029){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25040__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25040__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25040__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25040__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25041 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25041,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25041,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25041,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25041,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25041,(4),null);
var arity = cljs.core.nth.call(null,vec__25041,(5),null);
...
}catch (e25045){var _e__23900__auto__ = e25045;
...
var G__25046 = (obj[cljs.core.first.call(null,path)]);
var G__25047 = cljs.core.rest.call(null,path);
obj = G__25046;
path = G__25047;
continue;
} else {
...
return (function (accum,p__25048){
var vec__25049 = p__25048;
var bit = cljs.core.nth.call(null,vec__25049,(0),null);
var protocol = cljs.core.nth.call(null,vec__25049,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25052){
var vec__25053 = p__25052;
var ns = cljs.core.nth.call(null,vec__25053,(0),null);
var name = cljs.core.nth.call(null,vec__25053,(1),null);
var selector = cljs.core.nth.call(null,vec__25053,(2),null);
...
return (function (p__25057){
var vec__25058 = p__25057;
var munged_name = cljs.core.nth.call(null,vec__25058,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25058,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25058,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25056_SHARP_){
return (obj[cljs.core.first.call(null,p1__25056_SHARP_)]);
});})(name,sorted_matches,vec__25058,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1557582879250
