...
}catch (e47687){var _e = e47687;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___47690 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___47690)){
var seen_errors_47691 = temp__5455__auto___47690;
if(cljs.core.truth_(seen_errors_47691.has(self))){
} else {
seen_errors_47691.add(self);

var temp__5457__auto___47692 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___47692)){
var sense_47693 = temp__5457__auto___47692;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_47693)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1557588323529
