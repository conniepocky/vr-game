...
}catch (e29328){var _e = e29328;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___29331 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___29331)){
var seen_errors_29332 = temp__5455__auto___29331;
if(cljs.core.truth_(seen_errors_29332.has(self))){
} else {
seen_errors_29332.add(self);

var temp__5457__auto___29333 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___29333)){
var sense_29334 = temp__5457__auto___29333;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29334)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1557582890075
