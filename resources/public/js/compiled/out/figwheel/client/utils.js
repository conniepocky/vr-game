...
return (new CustomEvent(event_name,(function (){var obj49737 = {"detail":data};
return obj49737;
})()));
} else {
...
var f = (function (){var pred__49744 = cljs.core._EQ_;
var expr__49745 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49744.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49745))){
return ((function (pred__49744,expr__49745){
return (function (p1__49738_SHARP_){
return console.warn(p1__49738_SHARP_);
});
;})(pred__49744,expr__49745))
} else {
if(cljs.core.truth_(pred__49744.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49745))){
return ((function (pred__49744,expr__49745){
return (function (p1__49739_SHARP_){
return console.debug(p1__49739_SHARP_);
});
;})(pred__49744,expr__49745))
} else {
if(cljs.core.truth_(pred__49744.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49745))){
return ((function (pred__49744,expr__49745){
return (function (p1__49740_SHARP_){
return console.error(p1__49740_SHARP_);
});
;})(pred__49744,expr__49745))
} else {
return ((function (pred__49744,expr__49745){
return (function (p1__49741_SHARP_){
return console.log(p1__49741_SHARP_);
});
;})(pred__49744,expr__49745))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49748){
...
var opts = map__49749__$1;
var eval_fn = cljs.core.get.call(null,map__49749__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49751_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__49753,(0),null);
...
}catch (e49758){if((e49758 instanceof Error)){
var e = e49758;
return not_found;
} else {
throw e49758;
...
//# sourceMappingURL=utils.js.map?rel=1557588325963
