...
var G__25925 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__25925;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__25926 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__25926,ch);
...
if(("\\" === ch__$1)){
var ch_25927__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_25927__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_25927__$2);
} else {
}

var G__25928 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__25928;
continue;
}
}
...
var start_line = cljs.core.nth.call(null,vec__25936,(0),null);
var start_column = cljs.core.nth.call(null,vec__25936,(1),null);
...
var G__25939 = cljs.core.conj_BANG_.call(null,a,form);
a = G__25939;
continue;
}
}
...
var _STAR_read_delim_STAR_25940 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_25940;
}});
/**
...
var vec__25944 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25944,(0),null);
var end_column = cljs.core.nth.call(null,vec__25944,(1),null);
...
var vec__25947 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25947,(0),null);
var start_column = cljs.core.nth.call(null,vec__25947,(1),null);
...
var vec__25950 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25950,(0),null);
var end_column = cljs.core.nth.call(null,vec__25950,(1),null);
...
var sb = (function (){var G__25959 = (new goog.string.StringBuffer());
G__25959.append(initch);
...
var G__25961 = (function (){var G__25960 = sb;
G__25960.append(ch);
...
switch (G__25965) {
case "\\":
var G__25969 = (function (){var G__25966 = sb;
G__25966.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__25966;
})();
var G__25970 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25969;
ch = G__25970;
continue;
...
break;
default:
var G__25971 = (function (){var G__25967 = sb;
G__25967.append(ch);

return G__25967;
})();
var G__25972 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25971;
ch = G__25972;
continue;
...
var vec__25976 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25976,(0),null);
var column = cljs.core.nth.call(null,vec__25976,(1),null);
...
var vec__25981 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25981,(0),null);
var column = cljs.core.nth.call(null,vec__25981,(1),null);
...
var vec__25986 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25986,(0),null);
var column = cljs.core.nth.call(null,vec__25986,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__25991 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25991,(0),null);
var start_column = cljs.core.nth.call(null,vec__25991,(1),null);
...
var vec__25994 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25994,(0),null);
var end_column = cljs.core.nth.call(null,vec__25994,(1),null);
...
var G__25997 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__25997,true,null,opts,pending_forms);
...
var G__25998 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__25998)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__25998)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__25998)){
...
var _STAR_suppress_read_STAR_25999 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_25999;
}});
...
var G__26000 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26000,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26000,rdr,first_line);
...
var G__26004 = matched;
var G__26005 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26004;
finished = G__26005;
continue;
} else {
...
var _STAR_suppress_read_STAR_26006 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26006;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env26007 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26008 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26008,"(");
...
var G__26009 = (i + (1));
var G__26010 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env26007;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26011 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26011);
...
var G__26012 = cljs.core.next.call(null,s__$1);
var G__26013 = ret;
s__$1 = G__26012;
r = G__26013;
continue;
...
var G__26014 = cljs.core.next.call(null,s);
var G__26015 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26014;
key_vals = G__26015;
continue;
} else {
...
var gensym_env26019 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env26019;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26020 = token;
var G__26020__$1 = (((G__26020 == null))?null:cljs.core.subs.call(null,G__26020,(1)));
var G__26020__$2 = (((G__26020__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26020__$1));
var G__26020__$3 = (((G__26020__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26020__$2));
var G__26020__$4 = (((G__26020__$3 == null))?null:cljs.core.symbol.call(null,G__26020__$3));
if((G__26020__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26020__$4);
}
})():(function (){var G__26021 = token;
var G__26021__$1 = (((G__26021 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26021));
if((G__26021__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26021__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26032,reader){
...
var eof = cljs.core.get.call(null,map__26033__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26039){
var G__26040 = cljs.core.first.call(null,seq26039);
var seq26039__$1 = cljs.core.next.call(null,seq26039);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26040,seq26039__$1);
});


//# sourceMappingURL=reader.js.map?rel=1557580555147
